...
<body>
    <div id="cuerpo">
        ...
        <ul id='ulOferta'>
            ...
            <li>
                <strong>Título: Licencia de Conducir A</strong>
                <p>Título para motocicletas y ciclomotores.</p>
            </li>
            <li>
                <strong>Título: Licencia de Conducir C</strong>
                <p>Título para vehículos pesados, como camiones y autobuses.</p>
            </li>
        </ul>
        ...
        <ul>
            ...
            <li><strong>Cumplir las horas minimas de practicas.</strong></li>
